        ...
        <main class="w-full overflow-hidden">
            <div class="flex justify-around bg-grisPages p-5 text-noir">
                <div class="hautG">
                    ...
                    <div>
                        <button class="mx-auto my-10 text-sm md:my-20 md:text-base" v-if="montre.id_montre"
                ...
                <div class="">
                    <ul class="flex items-center gap-1 space-x-10">
                        <li>
                            <a href="#profil"><img src="/icones/flechesG.png" alt="Icônes flèches gauches" /></a>
                        </li>
                        ...
                        <li>
                            <a href="#face"><img src="/icones/flechesD.png" alt="Icônes flèches droites" /></a>
                        </li>
                    </ul>
                </div>
            </div>
